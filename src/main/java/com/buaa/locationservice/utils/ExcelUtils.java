...
public class ExcelUtils {
	...
	/**
	 * 生成excle直接下载不产生中间文件
	 * @param outputStream ResponseOutputStream
	 * @param data 数据源
	 */
	public static void writeWithTemplate(List<? extends BaseRowModel> data,OutputStream outputStream) {
		writeWithTemplateAndSheet(data,null,outputStream);
	}
	 ...
	 * @param sheet excle页面样式
	 */
	public static void writeWithTemplateAndSheet(List<? extends BaseRowModel> data, Sheet sheet,OutputStream outputStream) {
		if (CollectionUtils.isEmpty(data)) {
			return;
		}
