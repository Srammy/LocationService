...
public class LocationJobLowFrequency extends QuartzJobBean {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(LocationJobLowFrequency.class);
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        TelnetClientUtils tcu = new TelnetClientUtils();
        try {
            LocationInfo locationInfo = null;
            String result = tcu.login(hostName, userName, password);
            ...
            if (Constants.success.equals(result)) {
                ...
                if (result != null && !"".equals(result.trim()) && result.contains("Prog")) {
